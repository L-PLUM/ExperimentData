...
public class crawlerCode_rinkeby {
	public static void main(String[] args) throws IOException {
		String path = "./address/rinkeby/rinkebycontract2.xls";
		String url1 = "https://rinkeby.etherscan.io/address/";
		...
		for (int i = 1; i <501; i++) {
			...
			File file = new File("./smartcontract/rinkeby/rinkebycontract2/" + filename);
