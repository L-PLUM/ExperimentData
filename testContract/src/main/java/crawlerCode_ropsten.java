...
public class crawlerCode_ropsten {
	public static void main(String[] args) throws IOException {
		String path = "./address/ropsten/ropstencontract2.xls";
		String url1 = "https://ropsten.etherscan.io/address/";
		...
		for (int i = 1; i <501; i++) {
			...
			File file = new File("./smartcontract/ropsten/ropstencontract2/" + filename);
