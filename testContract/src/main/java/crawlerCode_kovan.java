...
public class crawlerCode_kovan {
	public static void main(String[] args) throws IOException {
		String path = "./address/kovan/kovancontract2.xls";
		String url1 = "https://kovan.etherscan.io/address/";
		List<Contract> list1 = readExcel(path);
		System.out.println(list1.size());

		List<Map<String, String>> list2 = new ArrayList<Map<String, String>>();

		for (int i = 331  ; i <501; i++) {
			...
			File file = new File("./smartcontract/kovan/kovancontract2/" + filename);
