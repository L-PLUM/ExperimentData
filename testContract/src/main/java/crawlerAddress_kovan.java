...
public class crawlerAddress_kovan {

    @SuppressWarnings("deprecation")
    public static void main(String[] args) throws Exception {
        // 采集的网址
        String url = "https://kovan.etherscan.io/contractsVerified/";
       // int  total_page =20;
       ...
       // System.out.println(pages);
        ...
        for (int current_page = 1; current_page <= total_page; current_page++) {
            ...
            try {
                FileOutputStream fos = new FileOutputStream("./address/kovan/kovancontract2.xls");
                wb.write(fos);
                fos.flush();
                fos.close();
            } catch (Exception e) {
